---
title: "Momento de Retroalimentación (Portafolio Implementación)"
subtitle: "Construcción de un Modelo Estadístico Base"
...
```{r}
plot(0, ylim = c(0,3), xlim = c(0, 1), yaxt = "n", ylab = "", xlab = "Tiempo de 
secado", main = "Secado de diferentes tipos de pintura")
...
```{r}
plot(A$fitted.values, A$residuals, ylab = "Residuos", xlab = "Valores Estimados")
abline(h = 0, col = "red")
```
